...
const SEED_USER_ID = "user_2iWQOka39Mv5Wkskkpz0t0nZQka"; // replace with your actual userId
...
const generateTransactionsForDay = (day: Date) => {
	...
	for (let i = 0; i < numTransactions; i++) {
		...
		const amount = Math.floor(generateRandomAmount(category)) * 1000; // Ensure amount is an integer
